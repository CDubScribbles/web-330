   ...
   betSelection.onchange = function() {
      ...
      if (pokerGame.currentBank >= pokerGame.currentBet) {
         ...
         for (let i = 0; i < cardImages.length; i++) {
            ...
            cardImages[i].onclick = (function(index) {
               return function() { //<== This was left out of the instructions from the textbook. Please make a note for future students.
                  if (this.src.includes("cardback.png")) {
                     // Show the front of the card
                     this.src = myHand.cards[index].cardImage();
                  } else {
